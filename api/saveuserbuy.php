...
include 'conUser.php';
//接收数据
$mes = isset($_POST['mes']) ? $_POST['mes'] : 'save';
$username = isset($_POST['username']) ? $_POST['username'] : '周星星';
$img = isset($_POST['img']) ? $_POST['img'] : '1';
$shop = isset($_POST['shop']) ? $_POST['shop'] : '1';
$intro = isset($_POST['intro']) ? $_POST['intro'] : '1';
...
if ($mes == 'del') {
    $sql5 = "DELETE FROM saveuserbuy WHERE username='$username'AND img='$img'";
    $res5 = $con->query($sql5);
}
?>